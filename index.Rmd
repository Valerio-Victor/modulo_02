---
title: "FUNDAMENTOS DA PRODUÇÃO DE H₂: ELETRÓLISE E CÉLULA A COMBUSTÍVEL"
...
```{r figura28, echo=FALSE, message=FALSE, warning=FALSE, out.width="70%", fig.align='center', fig.cap="Planta do Projeto Iberdrola Puertollano. Fonte: [39]."}
